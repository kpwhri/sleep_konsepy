...
Extracting ESS and AHI scores from clinical text.



## About

The regular expressions for this work were originally drawn from repository: https://github.com/nathanaelhwang/PromptNLP/. 
...
Or, if you need to extract matches from a corpus:
```bash
